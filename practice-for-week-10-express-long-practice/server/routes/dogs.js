...
router.get("/dogs", getAllDogs)
  .get("/dogs/:dogId", validateDogId, getDogById)
  .post("/dogs", validateDogInfo, createDog)
  .put("/dogs/:dogId", validateDogId, validateDogInfo, updateDog)
  .delete("/dogs/:dogId", validateDogId, deleteDog)
