...
const validateDogId = require("./dogs")
// ------------------------------  SERVER DATA ------------------------------
...
router.get("/dogs/:dogId/foods", validateDogId, getFoodsByDogId)
  .post("/dogs/:dogId/foods", validateDogId, validateFoodInfo, createFood)
